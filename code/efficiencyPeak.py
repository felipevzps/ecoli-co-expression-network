...
file = pd.read_csv("../results/clminfo.csv", sep=',', index_col=False)

# Extract last 2 numbers (14, 20 and 60) and transform "14" into "1.4"
file['inflation'] = file['source-name'].str.extract('I(\d+)$')[0].astype(int) / 10
print(file)
